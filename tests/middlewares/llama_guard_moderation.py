...
from cel.middlewares.moderation.llama3_guard_togetherai import Llama3GuardModerationMiddleware, ModerationResult
...
class Assistant():
    ...
    async def call_event(self, 
        ...
        assert isinstance(data['results'], ModerationResult)
...
async def test_flagged_message():
    ...
    middleware = Llama3GuardModerationMiddleware(
    ...
    message = MockMessage(lead, "chupame la pija")  
